...
img.src="/images/smiles/icon_"+icon+".gif";
...
"<option value='greens' style='color: green;'>绿色</option>",
...
tinyMCE.init({
plugins:"javaeye,flash,table,emotions,contextmenu",
mode:"none",
language:"zh_cn",
...
theme_advanced_buttons2:"undo,redo,cut,copy,paste,separator,justifyleft,justifycenter,justifyright,separator,outdent,indent,separator,link,unlink,image,flash,emotions,table,separator,quote,code",
...
content_css:"/javascripts/tiny_mce/plugins/javaeye/css/content.css",
setupcontent_callback:"setValueFix"
});
}
var setValueFix_HTML=false;
function setValueFix(editor_id,body,doc){
if(Prototype.Browser.IE&&setValueFix_HTML){
body.innerHTML=setValueFix_HTML;
setValueFix_HTML=false;
}
}
...
this.editor_bbcode_flag=document.createElement("input");
this.editor_bbcode_flag.type="hidden";
this.editor_bbcode_flag.name="bbcode";
$(textarea).parentNode.appendChild(this.editor_bbcode_flag);
...
if(!this.rich_editor)this.rich_editor=tinyMCE.getInstanceById(this.textarea);
}else{
...
getValue:function(){
return this.mode=="bbcode"?this.bbcode_editor.textarea.element.value:tinyMCE.getContent();
},
setValue:function(value){
if(this.mode=="bbcode"){
this.bbcode_editor.textarea.element.value=value;
}else{
setValueFix_HTML=value;
...
setInterval(this._autosave.bind(this),300*1000);
},
